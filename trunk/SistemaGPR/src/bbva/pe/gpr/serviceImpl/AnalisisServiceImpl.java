...
public class AnalisisServiceImpl  implements AnalisiService {
	...
	public AnalisisDAO getAnalisiDao(){return analisisDAO;}
	public void setAnalisiDao(AnalisisDAO analisiDao) {this.analisisDAO = analisiDao;}
	public AnalisisDAO getAnalisisDAO(){return analisisDAO;}
	public void setAnalisisDAO(AnalisisDAO analisisDAO) {this.analisisDAO = analisisDAO;}
	...
	public void ingresaSolicitudOperacion(Analisis analisisBean, String codTabla, String codProceso) throws Exception{
	...
	public SolicitudMensaje seteaMensajeBean(Analisis analisisBean){
