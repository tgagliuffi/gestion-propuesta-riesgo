...
public class SolicitudForm extends ActionForm {
	...
	private String tipo;
	private String mtoProducto=Constant.RESET_MONTO;
	private String mtoGarantia=Constant.RESET_MONTO;
	...
	public void setRegEvaluador(String regEvaluador) {
		this.regEvaluador = regEvaluador;
	}
	...
	public String getMtoProducto() {
		return mtoProducto;
	}

	public void setMtoProducto(String mtoProducto) {
		this.mtoProducto = mtoProducto;
	}

	public String getMtoGarantia() {
		return mtoGarantia;
	}

	public void setMtoGarantia(String mtoGarantia) {
	...
	public String getMtoTotalRow() {
		return mtoTotalRow;
	}

	public void setMtoTotalRow(String mtoTotalRow) {
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		mtoProducto=Constant.RESET_MONTO;
		mtoGarantia=Constant.RESET_MONTO;
		mtoTotalRow=Constant.RESET_MONTO;
		desMultMoneda=Constant.STR_VACIO;
