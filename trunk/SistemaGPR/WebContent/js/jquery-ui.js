...
function Datepicker() {
	...
	this.dpDiv = bindHover($('<div id="' + this._mainDivId + '" style="display:none;" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'));
}
...
$.extend(Datepicker.prototype, {
	...
	_newInst: function(target, inline) {
		...
		return {id: id, input: target, // associated target
			...
			bindHover($('<div class="' + this._inlineClass + ' style="display:none;" ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>')))};
	},
